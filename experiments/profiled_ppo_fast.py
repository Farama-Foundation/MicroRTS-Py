...
class Agent(nn.Module):
    ...
    def get_action(self, x, action=None, invalid_action_masks=None, envs=None, sw=None):
        ...
        if action is None:
            ...
            with sw.timer('get_unit_location_mask sample'):
            ...
            with sw.timer('get_unit_action_mask'):
            ...
            with sw.timer('get_unit_action_mask sample'):
