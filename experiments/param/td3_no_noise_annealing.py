...
if __name__ == "__main__":
    ...
    parser.add_argument('--gym-id', type=str, default="ParamOpEnv-v0",
    ...
    for step in range(args.episode_length):
        ...
        if global_step > args.learning_starts:
            ...
            with torch.no_grad():
                ...
                next_state_actions = (actor.forward(s_next_obses) + torch.Tensor(clipped_noise)).clamp(0, 1)
