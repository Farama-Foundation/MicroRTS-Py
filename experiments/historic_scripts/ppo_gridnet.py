...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-envs", type=int, default=16, help="the number of parallel game environment")
...
class Agent(nn.Module):
    ...
    def get_action(self, x, action=None, invalid_action_masks=None, envs=None):
        ...
        if action is None:
            ...
            source_unit_mask = torch.Tensor(np.array(envs.env_method("get_unit_location_mask1", player=0)))
            ...
            print(invalid_action_masks.shape)
