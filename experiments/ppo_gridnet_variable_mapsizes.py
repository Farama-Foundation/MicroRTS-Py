...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        self.actor = nn.Sequential(
            layer_init(nn.ConvTranspose2d(64, 32, 3, stride=1, padding=1)),
            nn.ReLU(),
            layer_init(nn.ConvTranspose2d(32, 78, 3, stride=1, padding=1)),
            Transpose((0, 2, 3, 1)),
        )
        ...
        self.critic_before_pooling = nn.Sequential(
            layer_init(nn.ConvTranspose2d(64, self.num_critic_channels, 3, stride=1, padding=1)),
            nn.ReLU(),
        )
    ...
    def get_action_and_value(self, x, action=None, invalid_action_masks=None, envs=None, device=None):
        ...
        logprob = logprob.T.view(-1, mapsize, num_predicted_parameters)
