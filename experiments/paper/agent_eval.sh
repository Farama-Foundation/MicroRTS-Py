...
python agent_eval.py --exp-name  ppo_gridnet_selfplay_diverse_encode_decode --agent-model-path trained_models/ppo_gridnet_selfplay_diverse_encode_decode/agent-1.pt \
    --max-steps 4000 --num-eval-runs 100 --wandb-entity vwxyzjn --wandb-project-name gym-microrts-paper-eval --prod-mode --capture-video
python agent_eval.py --exp-name  ppo_gridnet_selfplay_encode_decode --agent-model-path trained_models/ppo_gridnet_selfplay_encode_decode/agent-1.pt \
    --max-steps 4000 --num-eval-runs 100 --wandb-entity vwxyzjn --wandb-project-name gym-microrts-paper-eval --prod-mode --capture-video
