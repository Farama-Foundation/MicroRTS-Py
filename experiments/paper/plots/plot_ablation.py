...
f, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 10), sharex=True, gridspec_kw={"height_ratios": [1, 1.1]})
...
bar1 = sns.barplot(
    data=data, y=data.index, x="charts/cumulative_match_results/win rate", orient="h", capsize=0.5, ax=ax1, palette=palette
)
ax1.set_title("UAS")
ax1.set_xlabel("")
ax1.set_ylabel("")
...
bar2 = sns.barplot(
    data=data2, y=data2.index, x="charts/cumulative_match_results/win rate", orient="h", capsize=0.5, ax=ax2, palette=palette
)
