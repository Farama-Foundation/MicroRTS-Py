...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num-bot-envs", type=int, default=1, help="the number of bot game environment; 16 bot envs measn 16 games"
    )
    parser.add_argument(
    ...
    parser.add_argument("--agent-model-path", type=str, default="agent.pt", help="the path to the agent's model")
