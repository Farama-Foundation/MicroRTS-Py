...
def parse_args():
    ...
    args.num_envs = args.num_selfplay_envs + args.num_past_selfplay_envs + args.num_bot_envs
...
if __name__ == "__main__":
    ...
    envs = MicroRTSGridModeVecEnv(
        num_selfplay_envs=args.num_selfplay_envs + args.num_past_selfplay_envs,
