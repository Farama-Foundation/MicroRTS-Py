...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gym-id", type=str, default="MicrortsProduceCombatUnitsShapedReward-v1", help="the id of the gym environment"
    )
