...
# mine
assert env.step([1, 2, 0, 3, 0, 0, 0, 0, 0], True)[1][1] > 0
env.render()

# return
assert env.step([1, 3, 0, 0, 2, 0, 0, 0, 0], True)[1][1] > 0
env.render()

# build barracks
assert env.step([4, 4, 0, 0, 0, 2, 2, 0, 0], True)[1][4] > 0
env.render()
